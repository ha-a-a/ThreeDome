...
public final class Remote {
    ...
    public interface WriteRequestOrBuilder extends
        ...
        /**
         * <code>repeated .TimeSeries timeseries = 1 [(.gogoproto.nullable) = false];</code>
         */
        ...
        /**
         * <code>repeated .MetricMetadata metadata = 3 [(.gogoproto.nullable) = false];</code>
         */
                    ...
                    switch (tag) {
                        ...
                        case 26: {
                            if (!((mutable_bitField0_ & 0x00000002) != 0)) {
                                metadata_ = new java.util.ArrayList<Types.MetricMetadata>();
    ...
    public interface ReadRequestOrBuilder extends
         ...
         * </pre>
         *
         * <code>repeated .ReadRequest.ResponseType accepted_response_types = 2;</code>
    ...
    public static final class ReadRequest extends
            ...
            try {
                ...
                while (!done) {
                    ...
                    switch (tag) {
                        ...
                        case 10: {
                            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                                queries_ = new java.util.ArrayList<Query>();
                                mutable_bitField0_ |= 0x00000001;
                            }
                            queries_.add(
                                    input.readMessage(Query.parser(), extensionRegistry));
                            break;
                        }
                        case 16: {
                            int rawValue = input.readEnum();
                            if (!((mutable_bitField0_ & 0x00000002) != 0)) {
                                acceptedResponseTypes_ = new java.util.ArrayList<Integer>();
                                mutable_bitField0_ |= 0x00000002;
                            }
        ...
        /**
         * Protobuf enum {@code ReadRequest.ResponseType}
         */
        public enum ResponseType
             ...
             * Response headers:
             * Content-Type: "application/x-streamed-protobuf; proto=ChunkedReadResponse"
             * Content-Encoding: ""
             * </pre>
             *
            ...
            // @@protoc_insertion_point(enum_scope:ReadRequest.ResponseType)
        }
        ...
        private static final com.google.protobuf.Internal.ListAdapter.Converter<
                ...
                new com.google.protobuf.Internal.ListAdapter.Converter<
                    ...
                    public ResponseType convert(Integer from) {
                        ...
                        ResponseType result = ResponseType.valueOf(from);
    ...
    public interface ReadResponseOrBuilder extends
         ...
         * </pre>
         *
         * <code>repeated .QueryResult results = 1;</code>
         */
            ...
            try {
                ...
                while (!done) {
                    ...
                    switch (tag) {
                        ...
                        case 10: {
                            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                                results_ = new java.util.ArrayList<QueryResult>();
                                mutable_bitField0_ |= 0x00000001;
                            }
                            results_.add(
                                    input.readMessage(QueryResult.parser(), extensionRegistry));
                            break;
                        }
                        default: {
                            if (!parseUnknownField(
    ...
    public interface QueryOrBuilder extends
        ...
        /**
         * <code>repeated .LabelMatcher matchers = 3;</code>
         */
            ...
            try {
                ...
                while (!done) {
                    ...
                    switch (tag) {
                        ...
                        case 26: {
                            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                                matchers_ = new java.util.ArrayList<Types.LabelMatcher>();
                                mutable_bitField0_ |= 0x00000001;
                            }
                            matchers_.add(
                        ...
                        case 34: {
                            Types.ReadHints.Builder subBuilder = null;
                            if (hints_ != null) {
                                subBuilder = hints_.toBuilder();
                            }
                            hints_ = input.readMessage(Types.ReadHints.parser(), extensionRegistry);
                            if (subBuilder != null) {
        ...
        public static final class Builder extends
            ...
            public Builder mergeHints(Types.ReadHints value) {
                if (hintsBuilder_ == null) {
                    if (hints_ != null) {
                        hints_ =
                                Types.ReadHints.newBuilder(hints_).mergeFrom(value).buildPartial();
                    } else {
                        hints_ = value;
                    }
                    onChanged();
    ...
    public interface QueryResultOrBuilder extends
         ...
         * </pre>
         *
         * <code>repeated .TimeSeries timeseries = 1;</code>
         */
        java.util.List<Types.TimeSeries>
        getTimeseriesList();
        /**
    ...
    public interface ChunkedReadResponseOrBuilder extends
            // @@protoc_insertion_point(interface_extends:ChunkedReadResponse)
            com.google.protobuf.MessageOrBuilder {

        /**
         * <code>repeated .ChunkedSeries chunked_series = 1;</code>
         */
     ...
     * </pre>
     *
     * Protobuf type {@code ChunkedReadResponse}
     */
    public static final class ChunkedReadResponse extends
            com.google.protobuf.GeneratedMessageV3 implements
            // @@protoc_insertion_point(message_implements:ChunkedReadResponse)
            ...
            try {
                ...
                while (!done) {
                    ...
                    switch (tag) {
                        ...
                        case 10: {
                            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                                chunkedSeries_ = new java.util.ArrayList<Types.ChunkedSeries>();
                                mutable_bitField0_ |= 0x00000001;
                            }
                            chunkedSeries_.add(
        ...
        public static final class Builder extends
                com.google.protobuf.GeneratedMessageV3.Builder<Builder> implements
                // @@protoc_insertion_point(builder_implements:ChunkedReadResponse)
                ChunkedReadResponseOrBuilder {
            public static final com.google.protobuf.Descriptors.Descriptor
            getDescriptor() {
                return Remote.internal_static_prometheus_ChunkedReadResponse_descriptor;
            ...
            public Builder mergeFrom(
                    ...
                    com.google.protobuf.ExtensionRegistryLite extensionRegistry)
                    throws java.io.IOException {
                ChunkedReadResponse parsedMessage = null;
                try {
                    parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
                } catch (com.google.protobuf.InvalidProtocolBufferException e) {
                    parsedMessage = (ChunkedReadResponse) e.getUnfinishedMessage();
                    throw e.unwrapIOException();
                } finally {
                    if (parsedMessage != null) {
                        mergeFrom(parsedMessage);
            ...
            // @@protoc_insertion_point(builder_scope:ChunkedReadResponse)
        }

        // @@protoc_insertion_point(class_scope:ChunkedReadResponse)
    ...
    static {
        String[] descriptorData = {
                "\n\014remote.proto\022\nprometheus\032\013types.proto\032" +
                        ...
                        "\ntimeseries\030\001 \003(\0132\026.TimeSerie" +
                        "sB\004\310\336\037\000\0222\n\010metadata\030\003 \003(\0132\032.M" +
                        "etricMetadataB\004\310\336\037\000J\004\010\002\020\003\"\256\001\n\013ReadReques" +
                        "t\022\"\n\007queries\030\001 \003(\0132\021.Query\022E\n" +
                        ...
                        " \001(\003\022*\n\010matchers\030\003 \003(\0132\030.Labe" +
                        "lMatcher\022$\n\005hints\030\004 \001(\0132\025.Rea" +
